...
public class DynamicLinkerTest extends TestCase {
  ...
  public void testLoadLibInApkByFileName() {
    ...
    } else if (arch.endsWith("mips")) {
      System.load(apkPath + "!/lib/mips/libdynamiclinker_native_lib_b.so");
    } else if (arch.endsWith("mips64")) {
      System.load(apkPath + "!/lib/mips64/libdynamiclinker_native_lib_b.so");
    } else {
